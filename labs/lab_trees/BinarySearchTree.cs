...
namespace Lab9_BST
{
    ...
    public class EmployeeManagementSystem
    {
        ...
        {
            totalOperations++;
            // Implement insertion using recursive helper
        ...
        {
            // Base case: insert new node when we reach a null position
            if (node == null)
            {
            ...
            {
                // If the ID already exists, update the employee info
        ...
        private void InOrderRecursive(TreeNode? node)
        {
            ...
            Console.WriteLine(node.Employee.ToString());
